![Card Codex Social Banner](./img/card-codex-banner.jpg)
...
* [Read the Latest PDF (v0.2.0)](https://github.com/giffyglyph/giffyglyphs-card-codex/releases/download/v0.2.0/giffyglyphs_card_codex_v0_2_0_en.pdf)
...
| Cover                                               | Cards                                               |
| --------------------------------------------------- | --------------------------------------------------- |
| <img src="./img/card-codex-cover.jpg" width="100%"> | <img src="./img/card-codex-cards.jpg" width="100%"> |
